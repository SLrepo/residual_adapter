...
parser.add_argument('--expdir', default='/home/sihui/dem_learning/tmp/', help='Save folder')
parser.add_argument('--datadir', default='/home/sihui/Datasets/decathlon-1.0/', help='folder containing data folder')
parser.add_argument('--imdbdir', default='/home/sihui/Datasets/decathlon-1.0/annotations', help='annotation folder')
parser.add_argument('--source', default='/home/sihui/dem_learning/tmp/checkpoint/ckptbndefault11utensils.t7', type=str, help='Network source')
...
checkpoint = torch.load(args.source, map_location=torch.device('cpu'))
