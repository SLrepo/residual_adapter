...
def prepare_data_loaders(dataset_names, data_dir, imdb_dir, shuffle_train=True, index=None):
    ...
    for i in range(len(dataset_names)):
        ...
        if dataset_names[i] == 'utensils':
            means = [0.46777362093012576, 0.6135932417151215, 0.2328208309377359]
            stds = [0.0008833000524448309 * 256, 0.0007892927959734559 * 256, 0.0009240742942979917*256]
        elif dataset_names[i] == 'homeoffice':
            means = [0.6333775570385917, 0.6094804247840528, 0.5855149562113199]
            stds = [0.33719080173993865, 0.3426458677929906, 0.35270078847852765]
        else:
