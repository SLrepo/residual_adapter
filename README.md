This project is adapted from https://github.com/srebuffi/residual_adapters
To add new datasets, in addition to what is required from the original repo. Also need to:
